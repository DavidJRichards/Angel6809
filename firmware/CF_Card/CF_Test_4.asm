...
HHELP	FCC		"? - List the commands available."
		...
		FCB		$0D,$0A
		FCC		"l - Set the LBA addresses, without prompts"
		FCB		$0D,$0A		
		FCC		"r - Read a data block from the CF Card."
		FCB		$0D,$0A
		FCC		"R - Read a Flex sector from the CF Card."
		FCB		$0D,$0A
...
START	LDX		#STARTUP ;#NEWLINE		; Get a new line and print the input prompt
        SWI 
        FCB     PDATA 
		LDX		#PROMPT 
        SWI 
...
****************************************************
CFWAIT	PSHS	A, B
X1		LDB		CFSTATUSL	 	; Read the status register
		BITB	#$80			; Isolate the ready bit
		BNE		X1				; Wait for the bit to clear
