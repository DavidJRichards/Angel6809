...
ZF800   BRA     ZF808                    ;*F800: 20 06          ' .'
MF802   BRA     ZF83C                    ;*F802: 20 38          ' 8'
        BRA     ZF84B                    ;*F804: 20 45          ' E'
        BRA     ZF85A                    ;*F806: 20 52          ' R'
ZF808   PSHS    Y,X,D                    ;*F808: 34 36          '46'
        LDX     #MC400                   ;*F80A: 8E C4 00       '...'
        LDA     #$9E                     ;*F80D: 86 9E          '..'
        STA     $01,X                    ;*F80F: A7 01          '..'
        STA     $03,X                    ;*F811: A7 03          '..'
        LDA     #$0B                     ;*F813: 86 0B          '..'
        ...
        LEAY    <ZF85A,PCR               ;*F81F: 31 8C 38       '1.8'
        STY     ME7FA                    ;*F822: 10 BF E7 FA    '....'
        LEAY    <ZF83C,PCR               ;*F826: 31 8C 13       '1..'
        STY     ZE7FE                    ;*F829: 10 BF E7 FE    '....'
ZF82D   LDA     $01,X                    ;*F82D: A6 01          '..'
        ANDA    #$40                     ;*F82F: 84 40          '.@'
        BRA     ZF83A                    ;*F831: 20 07          ' .'
        LEAY    <ZF84B,PCR               ;*F833: 31 8C 15       '1..'
        STY     ZE7FC                    ;*F836: 10 BF E7 FC    '....'
ZF83A   PULS    PC,Y,X,D                 ;*F83A: 35 B6          '5.'
ZF83C   PSHS    X,B                      ;*F83C: 34 14          '4.'
...
ZF900   BRA     ZF90E                    ;*F900: 20 0C          ' .'
ZF902   BRA     ZF91A                    ;*F902: 20 16          ' .'
ZF904   BRA     ZF938                    ;*F904: 20 32          ' 2'
ZF906   BRA     ZF930                    ;*F906: 20 28          ' ('
ZF908   BRA     ZF93E                    ;*F908: 20 34          ' 4'
ZF90A   BRA     ZF958                    ;*F90A: 20 4C          ' L'
ZF90C   BRA     ZF962                    ;*F90C: 20 54          ' T'
ZF90E   PSHS D                             ;*F90E: 34 06          '4.'
        TFR     X,D                      ;*F910: 1F 10          '..'
        BSR     ZF91A                    ;*F912: 8D 06          '..'
        EXG     B,A                      ;*F914: 1E 98          '..'
        BSR     ZF91A                    ;*F916: 8D 02          '..'
        PULS    PC,D                     ;*F918: 35 86          '5.'
ZF91A   PSHS A                             ;*F91A: 34 02          '4.'
        ASRA                             ;*F91C: 47             'G'
        ASRA                             ;*F91D: 47             'G'
        ASRA                             ;*F91E: 47             'G'
        ASRA                             ;*F91F: 47             'G'
...
ZFA13   LDA     #$3A                     ;*FA13: 86 3A          '.:'
        JSR     [ZE7FC]                  ;*FA15: AD 9F E7 FC    '....'
        LDB     #$02                     ;*FA19: C6 02          '..'
        LBSR    ZFAA3                    ;*FA1B: 17 00 85       '...'
        LBSR    ZF902                    ;*FA1E: 17 FE E1       '...'
        LDA     #$3A                     ;*FA21: 86 3A          '.:'
        JSR     [ZE7FC]                  ;*FA23: AD 9F E7 FC    '....'
        LDB     #$00                     ;*FA27: C6 00          '..'
...
ZFAC9   LEAX    <MFAD3,PCR               ;*FAC9: 30 8C 07       '0..'
...
ZFC00   PSHS X                             ;*FC00: 34 10          '4.'
        LEAX    <ZFC30,PCR               ;*FC02: 30 8C 2B       '0.+'
        STX     ZE7FE                    ;*FC05: BF E7 FE       '...'
        LEAX    <MFC10,PCR               ;*FC08: 30 8C 05       '0..'
...
ZFC66   LDA     ,S                       ;*FC66: A6 E4          '..'
        LEAX    <MFC9C,PCR               ;*FC68: 30 8C 31       '0.1'
        LDA     A,X                      ;*FC6B: A6 86          '..'
        STA     ,S                       ;*FC6D: A7 E4          '..'
        LDB     #$0D                     ;*FC6F: C6 0D          '..'
...
ZFE00   LBRA    ZFE09                    ;*FE00: 16 00 06       '...'
ZFE03   LBRA    ZFE90                    ;*FE03: 16 00 8A       '...'
        LBRA    ZFE7E                    ;*FE06: 16 00 75       '..u'
ZFE09   LDA     #$2E                     ;*FE09: 86 2E          '..'
        PSHS A                             ;*FE0B: 34 02          '4.'
ZFE0D   LDA     #$0D                     ;*FE0D: 86 0D          '..'
        JSR     [ZE7FC]                  ;*FE0F: AD 9F E7 FC    '....'
        LDA     #$0A                     ;*FE13: 86 0A          '..'
        JSR     [ZE7FC]                  ;*FE15: AD 9F E7 FC    '....'
        LBSR    ZF904                    ;*FE19: 17 FA E8       '...'
        LBSR    ZF900                    ;*FE1C: 17 FA E1       '...'
        LBSR    ZF904                    ;*FE1F: 17 FA E2       '...'
        LDA     ,X                       ;*FE22: A6 84          '..'
        LBSR    ZF902                    ;*FE24: 17 FA DB       '...'
        LBSR    ZF904                    ;*FE27: 17 FA DA       '...'
        LDA     ,X                       ;*FE2A: A6 84          '..'
        JSR     [ZE7FC]                  ;*FE2C: AD 9F E7 FC    '....'
        JSR     [ZE7FE]                  ;*FE30: AD 9F E7 FE    '....'
        CMPA    #$58                     ;*FE34: 81 58          '.X'
        BEQ     ZFE5F                    ;*FE36: 27 27          ''''
        CMPA    #$47                     ;*FE38: 81 47          '.G'
        BEQ     ZFE7C                    ;*FE3A: 27 40          ''@'
        CMPA    #$2E                     ;*FE3C: 81 2E          '..'
        BNE     ZFE42                    ;*FE3E: 26 02          '&.'
        STA     ,S                       ;*FE40: A7 E4          '..'
ZFE42   CMPA    #$2F                     ;*FE42: 81 2F          './'
        BNE     ZFE48                    ;*FE44: 26 02          '&.'
        STA     ,S                       ;*FE46: A7 E4          '..'
ZFE48   CMPA    #$0D                     ;*FE48: 81 0D          '..'
        BEQ     ZFE62                    ;*FE4A: 27 16          ''.'
        CMPA    #$0A                     ;*FE4C: 81 0A          '..'
        BEQ     ZFE66                    ;*FE4E: 27 16          ''.'
        LBSR    ZFB02                    ;*FE50: 17 FC AF       '...'
...
ZFE90   LBSR    ZF906                    ;*FE90: 17 FA 73       '..s'
        LBSR    ZF904                    ;*FE93: 17 FA 6E       '..n'
        LBSR    ZF900                    ;*FE96: 17 FA 67       '..g'
ZFE99   JSR     [ZE7FE]                  ;*FE99: AD 9F E7 FE    '....'
        CMPA    #$58                     ;*FE9D: 81 58          '.X'
...
rRST 	LDS     #ME7B0                   ;*FF00: 10 CE E7 B0    '....'
        STS     ME7F8                    ;*FF04: 10 FF E7 F8    '....'
        LEAX    <MFF20,PCR ; nmi              ;*FF08: 30 8C 15       '0..'
        STX     ZE7F2                    ;*FF0B: BF E7 F2       '...'
        LEAX    <MFF81,PCR ; swi              ;*FF0E: 30 8C 70       '0.p'
